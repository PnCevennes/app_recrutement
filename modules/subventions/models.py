...
class DemandeSubvention(db.Model):
    ...
    sub_montant = db.Column(db.Integer)
    sub_cout_total = db.Column(db.Integer)
    sub_taux = db.Column(db.Integer)
    ...
    dec_montant = db.Column(db.Integer)
    dec_tva = db.Column(db.Integer)
    dec_taux = db.Column(db.Integer)
