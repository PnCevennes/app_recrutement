...
def render(templatename, data):
    '''
    Crée un document RTF à partir du modèle dont le nom est fourni et retourne un objet Response
    '''
    ...
    headers.add('Content-Disposition', 'attachment', filename='%s.rtf' % templatename)
...
def chunk2txt(chunk):
    ...
    '''
    _tr_base = ['', 'un', 'deux', 'trois', 'quatre', 'cinq', 'six', 'sept', 'huit', 'neuf']
    _tr_dix = ['', 'dix', 'vingt', 'trente', 'quarante', 'cinquante', 'soixante', 'soixante-dix', 'quatre-vingt', 'quatre-vingt-dix']
    _reps = {
            'dix-un': 'onze',
            'dix-deux': 'douze',
            'dix-trois': 'treize',
